...
//        val location = Location(41.303224, 69.236087, 5.0, 0)
            ...
            binding.apply {
                ...
                timeBomdod.text = "${fajr[0]}:${fajr[1]}"
                timeQuyosh.text = "${shuruq[0]}:${shuruq[1]}"
                timePeshin.text = "${thuhr[0]}:${thuhr[1]}"
                timeAsr.text = "${assr[0]}:${assr[1]}"
                timeShom.text = "${maghrib[0]}:${maghrib[1]}"
                timeXufton.text = prayerTimes.ishaa().toString()
